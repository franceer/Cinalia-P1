  ...
  return sequence([
    ...
    .then(function () {
        return Promise.join(
            ...
            knex.raw('ALTER SEQUENCE categories_locations_id_seq RESTART WITH 1;'),
            knex.raw('ALTER SEQUENCE categories_looks_id_seq RESTART WITH 1;'),
            knex.raw('ALTER SEQUENCE categories_products_id_seq RESTART WITH 1;'),
            knex.raw('ALTER SEQUENCE categories_sets_id_seq RESTART WITH 1;'),
            knex.raw('ALTER SEQUENCE categories_video_medias_id_seq RESTART WITH 1;'),
    ...
    .then(function () {
        ...
        return Promise.all(productSeedsCopy.map(function(seed) {       
            return helper.uploadImagesToS3({body: seed}, 'picture_url', ['name', 'brand_name']);          
        }))
    ...
    .then(function () {
        ...
        knex('looks').insert([{ name: 'Look de Julia', description: 'Retrouvez le look de Julia dans la scène au jardin du Luxembourg', time_codes: [4], media_character_id: 4, video_media_id: 1 },
        { name: 'Look de Timothée', description: 'Retrouvez le look de Timothée dans la scène au jardin du Luxembourg', time_codes: [4], media_character_id: 2, video_media_id: 1 }]),

        knex('sets').insert([{ name: 'Salon de la coloc\'', description: 'Salon de l\'apparetement du film Five, où les cinq protagonistes du film découvrent la vie en collocation.', picture_url: '/images/sets/five/five-la-coloc.jpg', picture_alt: 'Salon de la coloc\'', picture_title: 'Salon de la coloc\'', place: 'Paris - France', time_codes: [104], video_media_id: 1 }]));
    }).then(function () {
        return Promise.join(

        knex('categories_products')
        .insert([{ product_id: 1, category_id: 10 },
            { product_id: 2, category_id: 8 },
            { product_id: 3, category_id: 32 },
            { product_id: 4, category_id: 57 },
            { product_id: 5, category_id: 40 },
            { product_id: 6, category_id: 8 },
            { product_id: 7, category_id: 96 },
            { product_id: 8, category_id: 7 },
            { product_id: 9, category_id: 96 },
            { product_id: 10, category_id: 96 },
            { product_id: 11, category_id: 32 },
            { product_id: 12, category_id: 96 },
            { product_id: 13, category_id: 98 },
            { product_id: 14, category_id: 98 },
            { product_id: 15, category_id: 21 },
            { product_id: 16, category_id: 98 },
            { product_id: 17, category_id: 32 },
            { product_id: 21, category_id: 31 },
            { product_id: 22, category_id: 31 },
            { product_id: 23, category_id: 31 },
            { product_id: 24, category_id: 30 },
            { product_id: 25, category_id: 8 },
            { product_id: 26, category_id: 28 },
            { product_id: 27, category_id: 14 },
            { product_id: 28, category_id: 28 },
            { product_id: 29, category_id: 8 },
            { product_id: 30, category_id: 12 },
            { product_id: 31, category_id: 16 }]),

        knex('categories_video_medias')
        .insert([{ video_media_id: 1, category_id: 105 },
        { video_media_id: 2, category_id: 105 }]),

        knex('categories_locations')
        .insert([{ location_id: 1, category_id: 102 },
        { location_id: 2, category_id: 102 }]),

        knex('categories_looks')
        .insert([{ look_id: 1, category_id: 103 }]),

        knex('categories_sets')
        .insert([{ set_id: 1, category_id: 104 }]),
