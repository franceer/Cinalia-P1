...
exports.seed = function(knex, Promise) {
    ...
    .then(function () {
        var locationSeeds = [{ name: 'Jardin du Luxembourg', description: 'Le jardin du Luxembourg est un jardin ouvert au public, situé dans le 6e arrondissement de Paris. Il comprend un musée, un hôtel particulier, une orangerie, un manège...', city_state_country: 'Paris 6ème arrondissement, France', picture_url: 'http://fabientijou.com/wp-content/uploads/2014/04/Michel-Jardin-1100px-L.jpg', picture_alt: 'Jardin du Luxembourg', picture_title: 'Jardin du Luxembourg', place_id: 'ChIJe2jeNttx5kcRi_mJsGHdkQc', latitude: '48.8462252', longitude: '2.3349718', zoom: '13' },
          { name: 'Le Pentagone', description: 'Le Pentagone est un bâtiment qui se trouve à Arlington en Virginie, près de Washington, la capitale fédérale des États-Unis. Cet édifice abrite le quartier général du département de la Défense. En 2009, plus de 26 000 personnes y travaillent, parmi lesquelles des civils et des militaires. Son nom provient de la forme de son plan, un pentagone. (wikipédia)', city_state_country: 'Arlington, Virgine - USA', picture_url: 'http://www.silicon.fr/wp-content/uploads/2016/03/Pentagone.jpg', picture_alt: 'Le Pentagone', picture_title: 'Le Pentagone', place_id: 'ChIJJyztKd-2t4kRL1MTwPjQg68', latitude: '38.8713995', longitude: '-77.0571467', zoom: '16' }];

        return Promise.all(locationSeeds.map(function (seed) {
            return helper.uploadImagesToS3({ body: seed }, 'picture_url', ['name'], 'location');
        }))
