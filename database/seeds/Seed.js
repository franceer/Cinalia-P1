...
exports.seed = function(knex, Promise) {
    ...
    .then(function () {
        var setSeeds = [{ name: 'Salon de la coloc\'', description: 'Salon de l\'appartement du film Five, où les cinq protagonistes du film découvrent la vie en collocation.', picture_url: 'https://s3.eu-central-1.amazonaws.com/in-movies/assets/five-la-coloc.jpg', picture_alt: 'Salon de la coloc\'', picture_title: 'Salon de la coloc\'', place: 'Paris - France', time_codes: [104], video_media_id: 1 }];
    ...
    .then(function () {
        return knex('looks').insert([{ name: 'Look de Julia', description: 'Retrouvez le look de Julia dans la scène au jardin du Luxembourg', time_codes: [4], character_name: 'Julia', character_type_id: 2, video_media_id: 1 },
        { name: 'Look de Timothée', description: 'Retrouvez le look de Timothée dans la scène au jardin du Luxembourg', time_codes: [4], character_name: 'Timothée', character_type_id: 1, video_media_id: 1 }]);
    }).then(function () {
        return Promise.join(
