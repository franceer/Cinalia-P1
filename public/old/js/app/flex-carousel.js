...
define(['jquery'], function (jquery) {
    ...
    (function ($) {
        $.fn.flexCarousel = function (options) {
            ...
            var init = function () {
                $this.each(function () {
                    carousels.push(new FlexCarousel($(this), settings));
                });
    ...
    function FlexCarousel($carousel, settings) {
        ...
        this.$toggleButtons = $(settings.toggleButtonClass + '[data-slide=' + this.$carouselNode.attr('id') + ']'),
        this.$paginButtons = $(settings.paginButtonClass + '[data-slide=' + this.$carouselNode.attr('id') + '] button');
